...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_ROCKET_GRUNT_M,
    TRAINER_PIC_FRONT_ROCKET_GRUNT_F,
    TRAINER_PIC_FRONT_PETREL,
    TRAINER_PIC_FRONT_LEADER_BLAINE,
    TRAINER_PIC_FRONT_MR_FUJI,
    TRAINER_PIC_FRONT_PROTON,
    TRAINER_PIC_FRONT_POLICEMAN,
    TRAINER_PIC_FRONT_FIREBREATHER,
    TRAINER_PIC_FRONT_ENGINEER,
    TRAINER_PIC_FRONT_BURGLAR,
    TRAINER_PIC_FRONT_ARIANA,
    TRAINER_PIC_FRONT_SUPER_NERD,
    TRAINER_PIC_FRONT_ELITE_FOUR_WILL,
    TRAINER_PIC_FRONT_ELITE_FOUR_KOGA,
    TRAINER_PIC_FRONT_ELITE_FOUR_BRUNO,
    TRAINER_PIC_FRONT_ELITE_FOUR_KAREN,
    TRAINER_PIC_FRONT_LEADER_FALKNER,
    TRAINER_PIC_FRONT_LEADER_BUGSY,
    TRAINER_PIC_FRONT_LEADER_WHITNEY,
    TRAINER_PIC_FRONT_LEADER_MORTY,
    TRAINER_PIC_FRONT_LEADER_JASMINE,
    TRAINER_PIC_FRONT_LEADER_CHUCK,
    TRAINER_PIC_FRONT_LEADER_BLUE,
    TRAINER_PIC_FRONT_LEADER_CLAIR,
    TRAINER_PIC_FRONT_CHAMPION_LANCE,
    TRAINER_PIC_FRONT_KIMONO_GIRL,
    TRAINER_PIC_FRONT_EUSINE,
    TRAINER_PIC_FRONT_LEADER_PRYCE,
    TRAINER_PIC_FRONT_BIKER,
    TRAINER_PIC_FRONT_SAGE,
    TRAINER_PIC_FRONT_ELDER,
    TRAINER_PIC_FRONT_JUGGLER,
    TRAINER_PIC_FRONT_SILVER,
    TRAINER_PIC_FRONT_ARCHER,
    TRAINER_PIC_FRONT_LEADER_BROCK,
    TRAINER_PIC_FRONT_LEADER_MISTY,
    TRAINER_PIC_FRONT_LEADER_SURGE,
    TRAINER_PIC_FRONT_LEADER_ERIKA,
    TRAINER_PIC_FRONT_LEADER_JANINE,
    TRAINER_PIC_FRONT_LEADER_SABRINA,
    TRAINER_PIC_FRONT_GIOVANNI,
    TRAINER_PIC_FRONT_NURSE,
    TRAINER_PIC_FRONT_LEADER_TATE,
    TRAINER_PIC_FRONT_LEADER_LIZA,
    TRAINER_PIC_FRONT_SCIENTIST,
    TRAINER_PIC_FRONT_GHOST,
    TRAINER_PIC_FRONT_GAMBLER,
    TRAINER_PIC_FRONT_LUSAMINE,
    TRAINER_PIC_FRONT_GLADION,
    TRAINER_PIC_FRONT_LILLIE,
...
#define TRAINER_ENCOUNTER_MUSIC_SILVER             22
#define TRAINER_ENCOUNTER_MUSIC_ROCKET             23
#define TRAINER_ENCOUNTER_MUSIC_HG_KIMONO_GIRL     24
#define TRAINER_ENCOUNTER_MUSIC_DP_BOY             25
#define TRAINER_ENCOUNTER_MUSIC_DP_TWINS           26
#define TRAINER_ENCOUNTER_MUSIC_DP_INTENSE         27
#define TRAINER_ENCOUNTER_MUSIC_DP_GALACTIC        28
#define TRAINER_ENCOUNTER_MUSIC_DP_LADY            29
#define TRAINER_ENCOUNTER_MUSIC_DP_HIKER           30
#define TRAINER_ENCOUNTER_MUSIC_DP_RICH            31
#define TRAINER_ENCOUNTER_MUSIC_DP_SAILOR          32
#define TRAINER_ENCOUNTER_MUSIC_DP_SUSPICIOUS      33
#define TRAINER_ENCOUNTER_MUSIC_DP_ACE_TRAINER     34
#define TRAINER_ENCOUNTER_MUSIC_DP_GIRL            35
#define TRAINER_ENCOUNTER_MUSIC_DP_CYCLIST         36
#define TRAINER_ENCOUNTER_MUSIC_DP_ARTIST          37
#define TRAINER_ENCOUNTER_MUSIC_DP_ELITE_FOUR      38
#define TRAINER_ENCOUNTER_MUSIC_DP_CHAMPION        39
