...
#define BATTLE_TYPE_HAS_AI                  (BATTLE_TYPE_TRAINER | BATTLE_TYPE_FIRST_BATTLE | BATTLE_TYPE_SAFARI | BATTLE_TYPE_ROAMER | BATTLE_TYPE_INGAME_PARTNER | BATTLE_TYPE_BOSS)

#define BOSS_PHASE_PROFILE_NONE       0
#define BOSS_PHASE_PROFILE_MEWTWO     1
#define BOSS_PHASE_PROFILE_OGERPON    2
#define BOSS_PHASE_PROFILE_RAYQUAZA   3
#define BOSS_PHASE_PROFILE_HOOPA      4
#define BOSS_PHASE_PROFILE_KYOGRE     5
#define BOSS_PHASE_PROFILE_GROUDON    6
#define BOSS_PHASE_PROFILE_DIALGA     7
#define BOSS_PHASE_PROFILE_PALKIA     8
#define BOSS_PHASE_PROFILE_GIRATINA   9
#define BOSS_PHASE_PROFILE_NECROZMA   10 // Ultra Necrozma at the Sun and Moon Altar (.claude/rift_missions/ALTAR_SUN_MOON/ALTAR_SUN_MOON_IMPLEMENTATION.md section 8.4)
#define BOSS_PHASE_PROFILE_COUNT      11
...
#define VOLATILE_DEFINITIONS(F) \
    ...
    F(VOLATILE_AURA_SHIELD_STATE,           auraShieldState,               (u32, 2)) \
    ...
    F(VOLATILE_FROST_NOVA_TIMER,            frostNovaTimer,                (u32, 2)) \
    ...
    F(VOLATILE_OVERLOCK,                    overlock,                      (u32, 1)) \
...
#define STATUS_FIELD_SCORCHED_FIELD                 (1 << 12)

#define STATUS_FIELD_TERRAIN_ANY        (STATUS_FIELD_GRASSY_TERRAIN | STATUS_FIELD_MISTY_TERRAIN | STATUS_FIELD_ELECTRIC_TERRAIN | STATUS_FIELD_PSYCHIC_TERRAIN | STATUS_FIELD_SCORCHED_FIELD)
...
#define B_WEATHER_TWILIGHT      (1 << BATTLE_WEATHER_TWILIGHT)

#define B_WEATHER_DAMAGING_ANY  (B_WEATHER_HAIL | B_WEATHER_SANDSTORM)
#define B_WEATHER_ICY_ANY       (B_WEATHER_HAIL | B_WEATHER_SNOW)
#define B_WEATHER_LOW_LIGHT     (B_WEATHER_FOG | B_WEATHER_ICY_ANY | B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_TWILIGHT)
#define B_WEATHER_PRIMAL_ANY    (B_WEATHER_RAIN_PRIMAL | B_WEATHER_SUN_PRIMAL | B_WEATHER_STRONG_WINDS)
#define B_WEATHER_ANY           (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_ICY_ANY | B_WEATHER_STRONG_WINDS | B_WEATHER_FOG | B_WEATHER_TWILIGHT)
...
#define B_CATCH_OR_NOT           25
#define B_WIN_POST_CATCH_MENU    26
...
#define STARTING_STATUS_DEFINITIONS(F) \
    ...
    F(STARTING_STATUS_SCORCHED_FIELD,                 scorchedField,              (u32, 1)) /* Scorched Field (Permanent) */               \
    F(STARTING_STATUS_SCORCHED_FIELD_TEMPORARY,       scorchedFieldTemporary,     (u32, 1)) /* Scorched Field Temporary (5 turns) */       \
