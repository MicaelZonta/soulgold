...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_SNOWTOP_MOUNTAIN] = {MAP_GROUP(MAP_SNOWTOP_MOUNTAIN_OUTSIDE), MAP_NUM(MAP_SNOWTOP_MOUNTAIN_OUTSIDE), HEAL_LOCATION_SNOWTOP_MOUNTAIN_OUTSIDE},
    [MAPSEC_RINTO_VILLAGE] = {MAP_GROUP(MAP_RINTO_VILLAGE), MAP_NUM(MAP_RINTO_VILLAGE), HEAL_LOCATION_RINTO_VILLAGE},
    [MAPSEC_BATTLE_TOWER] = {MAP_GROUP(MAP_TRAINER_HILL_COURTYARD), MAP_NUM(MAP_TRAINER_HILL_COURTYARD), HEAL_LOCATION_TRAINER_HILL_COURTYARD},
...
static const mapsec_u16_t sFlyDestinations[][2] =
{
    ...
    {MAPSEC_SNOWTOP_MOUNTAIN, FLAG_VISITED_SNOWTOP_MOUNTAIN},
    {MAPSEC_RINTO_VILLAGE,    FLAG_VISITED_RINTO_VILLAGE},
    {MAPSEC_BATTLE_TOWER,     FLAG_VISITED_BATTLE_TOWER},
    {MAPSEC_BATTLE_FACTORY,   FLAG_VISITED_BATTLE_FACTORY},
    ...
    {MAPSEC_METEOR_ISLAND,     FLAG_VISITED_METEOR_CAVE},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_SNOWTOP_MOUNTAIN:
        return FlagGet(FLAG_VISITED_SNOWTOP_MOUNTAIN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_RINTO_VILLAGE:
        return FlagGet(FLAG_VISITED_RINTO_VILLAGE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_BATTLE_TOWER:
        return FlagGet(FLAG_VISITED_BATTLE_TOWER) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_BATTLE_FACTORY:
        return FlagGet(FLAG_VISITED_BATTLE_FACTORY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_METEOR_ISLAND:
