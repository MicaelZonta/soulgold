...
const struct Tileset gTileset_ArcadeLobby =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_ArcadeLobby,
    .palettes = gTilesetPalettes_ArcadeLobby,
    .metatiles = gMetatiles_ArcadeLobby,
...
const struct Tileset gTileset_MysteryDungeon =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_MysteryDungeon,
    .palettes = gTilesetPalettes_MysteryDungeon,
    .metatiles = gMetatiles_MysteryDungeon,
...
const struct Tileset gTileset_TohjoPass =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_TohjoPass,
    .palettes = gTilesetPalettes_TohjoPass,
    .metatiles = gMetatiles_TohjoPass,
