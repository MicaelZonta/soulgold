...
| Constante | Arquivo |
|---|---|
| `TRAINER_PIC_FRONT_AQUA_ADMIN_F` | `graphics/trainers/front_pics/aqua_admin_f.png` |

### Field mugshot

Não existe. Opcional; criar com a skill `adicionar-grafico-trainer` (precisa do `case` em `GetFieldMugshotIdByObjectGraphicsId`).

> **Atenção:** Não há overworld próprio: só o genérico `OBJ_EVENT_GFX_AQUA_MEMBER_F` (recruta), que não serve como a personagem.
