...
- **Acerola — Fantasma** (Alola · Trial Captains) — órfã de origem nobre que vive na Aether House.
- **Acerola — Fantasma** (Alola · Elite Four e Campeões) — ocupa a vaga destinada ao indisponível Nanu.
