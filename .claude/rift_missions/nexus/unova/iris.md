...
- **Iris — Dragão** (Unova · Líderes de Ginásio) — prodígio que se torna Campeã em *Black 2/White 2*.
- **Iris — Campeã** (Unova · Elite Four e Campeões) — jovem mestre de dragões e Campeã na sequência de Unova.
