...
- **Bede** (Galar · Rivais de Galar) — treinador patrocinado por Rose que posteriormente herda o Ginásio de Fada.
- **Bede — Fada** (Galar · Líderes de Ginásio) — torna-se sucessor de Opal.
- **Bede** (Galar · Campeão e Champion Cup) — retorna como sucessor de Opal e desafia o protagonista.
