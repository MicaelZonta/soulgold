...
- **Hop** (Galar · Rivais de Galar) — irmão de Leon que busca tornar-se Campeão e depois encontra vocação como pesquisador.
- **Hop** (Galar · Campeão e Champion Cup) — compete na Champion Cup para tentar superar o irmão.
